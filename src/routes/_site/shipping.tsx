  ...
  component: () => (
    <StaticPage title="Shipping" eyebrow="Support">
      <section className="space-y-6">
        ...
        <p>
          Orders within Accra are usually delivered within 1-2 business days. Outside Accra, please
          allow 3-5 business days for delivery via our trusted courier partners.
        </p>
        <h3 className="text-cocoa font-bold">International Shipping</h3>
        <p>
          We ship globally! International delivery times vary by destination, typically taking 7-14
          business days.
        </p>
        <h3 className="text-cocoa font-bold">Returns & Exchanges</h3>
        <p>
          If you are not completely satisfied with your purchase, you may return unworn items in
          their original packaging within 14 days of delivery for an exchange or store credit.
        </p>
      </section>
    </StaticPage>
  ),
