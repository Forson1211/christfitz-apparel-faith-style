  ...
  return (
    <StaticPage title="FAQs" eyebrow="Support">
      <div className="space-y-4">
        {FAQS.map((faq, i) => (
          <div key={i} className="rounded-3xl border border-cocoa/10 bg-white/50 overflow-hidden">
            <button
            ...
            <AnimatePresence>
              {openIndex === i && (
                ...
                >
                  <div className="p-6 pt-0 text-muted-foreground leading-relaxed">{faq.a}</div>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
