  ...
  component: () => (
    <StaticPage title="Privacy" eyebrow="Legal">
      <section className="space-y-6">
        ...
        <p>
          At ChristFitz Apparel, we respect your privacy as much as we respect our craft. This policy 
        ...
        <p>
          ...
          newsletter, or contact our support team. This may include your name, email address, 
        ...
        <p>
          ...
          and (with your permission) send you updates about new collections and spiritual insights.
        </p>
